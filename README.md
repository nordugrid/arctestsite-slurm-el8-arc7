...
View arc.conf via curl or web-broser with: [http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arcconf](http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arcconf)

## Read ARC log files
Browse ARC log files via curl or web-browser with: [http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arclogs](http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arclogs)


## Check ARC state
View ARC state via curl or web-browser with: [http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arcstatus](http://arctestcluster-slurm-el8-arc7-ce1.cern-test.uiocloud.no/arcstatus)
